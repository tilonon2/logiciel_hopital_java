...
public class UtilisateursController implements Initializable {
    ...
    private void chargerDonnees() {
            ...
            while (rs.next()) {
                ...
                Utilisateur user = new Utilisateur(id, nom, prenom, sexe,dateNaissance,fonction,mdp,typeUser);
    ...
    private void ajouter(ActionEvent event) {
        try (Connection conn = dbManager.getConnection();
             PreparedStatement pst = conn.prepareStatement("INSERT INTO user (nom, prenom, sexe, date_naissance, fonction, mdp, type_user) VALUES (?, ?, ?, ?, ?, ?, ?)")) {
            String nom = nom_user.getText();
            String mdp = mdp_user.getText();
            String prenom = prenom_user.getText();
            String sexe = sexe_m_user.isSelected() ? "M" : "F";
            ...
            if (nom.isEmpty() || prenom.isEmpty() || dateNaissance == null || selectedType == null) {
